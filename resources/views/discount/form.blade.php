            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="discount_type" class="col-lg-2 col-lg-offset-1 control-label">Discount Type</label>
                        <div class="col-lg-6">
                            <input type="text" name="discount_type" id="discount_type" class="form-control" required autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="percentage" class="col-lg-2 col-lg-offset-1 control-label">Percentage</label>
                        <div class="col-lg-6">
